...
<li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu  mt-n1 ">
            ...
            <li>
                <a class="dropdown-item "
                   rel="nofollow"
                   href="/accounts/login/?next=/person/gdawra.ietf%40gmail.com">
                    Sign in
                </a>
            </li>
            <li>
        ...
        <h2 class="mt-5" id="rfcs-1">
            RFCs <small class="text-body-secondary">(6)</small>
        </h2>
        ...
        <h2 class="mt-5" id="drafts-1">
            ...
            <ul>
                    ...
                    <li>
                        <a href="/doc/draft-ietf-lsvr-applicability/">draft-ietf-lsvr-applicability</a>
                    </li>
                    ...
                    <li>
                        <a href="/doc/draft-ietf-rtgwg-atn-bgp/">draft-ietf-rtgwg-atn-bgp</a>
                    </li>
                
            </ul>
        
        <h2 class="mt-5">
            Expired Internet-Drafts <small class="text-body-secondary">(23)</small>
        </h2>
            ...
            <ul>
                        ...
                        <li>
                            <a href="/doc/draft-jags-spring-sr-service-programming-yang/">
                        ...
                        <li>
                            <a href="/doc/draft-templin-rtgwg-scalable-bgp/">
                        ...
                        <li>
                            <a href="/doc/draft-keyupate-ietf-applicability/">
                                draft-keyupate-ietf-applicability
                            </a>
                        </li>
    ...
    <script>
        $(function () {
                    ...
                    $.getJSON('/doc/stats/person/122892/drafts/conf', function (conf) {
                        // Create the chart
                        chart = Highcharts.stockChart('chart-1', conf);
                        chart.showLoading();
                        $.getJSON('/doc/stats/person/122892/drafts/data', function (data) {
...
<noscript><p><img src="//analytics.ietf.org/piwik.php?idsite=7" style="border:0;" alt="" /></p></noscript>
    ...
    <script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'90f987635dafe370',t:'MTczOTE2MzU1Ni4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>